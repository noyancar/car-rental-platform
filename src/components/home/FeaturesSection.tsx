      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="flex flex-col items-center text-center p-4 sm:p-5 md:p-6 rounded-lg hover:shadow-md transition-shadow">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-primary-100 flex items-center justify-center mb-3 sm:mb-4">
              <CarIcon className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-primary-800" />
            </div>
          ...
          <div className="flex flex-col items-center text-center p-4 sm:p-5 md:p-6 rounded-lg hover:shadow-md transition-shadow">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-primary-100 flex items-center justify-center mb-3 sm:mb-4">
              <ShieldCheck className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-primary-800" />
            </div>
            <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-1.5 sm:mb-2">Fully Insured</h3>
            <p className="text-sm sm:text-base text-secondary-600">
          ...
          <div className="flex flex-col items-center text-center p-4 sm:p-5 md:p-6 rounded-lg hover:shadow-md transition-shadow">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-primary-100 flex items-center justify-center mb-3 sm:mb-4">
              <CalendarDays className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-primary-800" />
            </div>
          ...
          <div className="flex flex-col items-center text-center p-4 sm:p-5 md:p-6 rounded-lg hover:shadow-md transition-shadow">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-primary-100 flex items-center justify-center mb-3 sm:mb-4">
              <CheckCircle className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-primary-800" />
            </div>
