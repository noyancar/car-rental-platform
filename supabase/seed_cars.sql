-- Seed data for cars with new CSV format
...
('Kia', 'Sorento', 'S', 2025, 'Wolf Gray', '063025', 7, 4, 'Gas', 'Regular', 
 ...
 'Automatic', 'Unlimited', true, 'https://images.unsplash.com/photo-1629834468948-2ccdec4b9b0d'),

-- Chrysler Pacifica Touring L 2024
('Chrysler', 'Pacifica', 'Touring L', 2024, 'White', 'YAC429', 7, 4, 'Gas', 'Regular',
 ...
 'Automatic', 'Unlimited', true, 'https://images.unsplash.com/photo-1619767886558-efdc259cde1a'),
...
('Dodge', 'Challenger', 'R/T', 2022, 'Red', 'WJY644', 5, 2, 'Gas', 'Premium',
 ...
 'Automatic', '150 miles/day', true, 'https://images.unsplash.com/photo-1626668011687-a63fe9bc19a9'),

-- Ford Bronco Black Diamond 2024 (Velocity Blue)
('Ford', 'Bronco', 'Black Diamond', 2024, 'Velocity Blue Metallic', '904HEK', 5, 4, 'Gas', 'Regular',
 ...
 'Rugged off-road SUV with removable top and doors.',
 'Manual', 'Unlimited', true, 'https://images.unsplash.com/photo-1622193724842-3170ef043adb'),

-- Ford Bronco Black Diamond 2024 (Eruption Green)
...
-- Jeep Gladiator Nighthawk 2024 (Yellow)
('Jeep', 'Gladiator', 'Nighthawk', 2024, 'Yellow', 'LPT833', 5, 4, 'Gas', 'Regular',
 ...
 'The only open-air pickup truck with best-in-class towing and payload.',
 'Automatic', 'Unlimited', true, 'https://images.unsplash.com/photo-1620591309146-1a4f2c8faaa9'),

-- Jeep Gladiator Nighthawk 2024 (Blue)
...
-- Jeep Gladiator Nighthawk 2024 (Yellow) - Another unit
...
-- Jeep Grand Cherokee L Limited 2023
('Jeep', 'Grand Cherokee L', 'Limited', 2023, 'Velvet Red Pearlcoat', 'WWB650', 6, 4, 'Gas', 'Regular',
 ...
 'Automatic', 'Unlimited', true, 'https://images.unsplash.com/photo-1609521263047-f8f205293b24'),

-- Jeep Wrangler Sahara 2023 (White) - Unit 1
('Jeep', 'Wrangler', 'Sahara', 2023, 'White', 'WSG213', 5, 4, 'Gas', 'Regular',
 ...
 'Iconic off-road vehicle with removable doors and roof.',
 'Automatic', 'Unlimited', true, 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf'),

-- Jeep Wrangler Sahara 2023 (White) - Unit 2
...
-- Jeep Wrangler Sport S 2024 (Anvil)
('Jeep', 'Wrangler', 'Sport S', 2024, 'Anvil', '173TYH', 5, 4, 'Gas', 'Regular',
 ...
 'Manual', 'Unlimited', true, 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf'),

-- Jeep Wrangler Sport S 2024 (Silver)
...
-- Jeep Wrangler Sport S 2025 (White) - Unit 1
...
-- Jeep Wrangler Sport S 2025 (White) - Unit 2
...
-- Jeep Wrangler Sport S 2025 (White) - Unit 3
...
-- Jeep Wrangler Sport S 2025 (White) - Unit 4
...
-- Mini Convertible Cooper S 2024 (Island Blue)
('Mini', 'Convertible', 'Cooper S', 2024, 'Island Blue', 'WXA497', 4, 2, 'Gas', 'Premium',
 ...
 'Fun-to-drive convertible with go-kart handling and premium features.',
 'Manual', '200 miles/day', true, 'https://images.unsplash.com/photo-1609965803451-43c6e8d7b346'),

-- Mini Convertible Cooper S 2024 (Chili Red)
...
-- Update car images with multiple URLs for some vehicles
UPDATE cars SET 
  image_urls = ARRAY[
    'https://images.unsplash.com/photo-1629834468948-2ccdec4b9b0d',
    'https://images.unsplash.com/photo-1629834469043-b8e0a5d8376e',
    'https://images.unsplash.com/photo-1629834468707-31f21b6b7c27'
  ],
  main_image_index = 0
...
UPDATE cars SET 
  image_urls = ARRAY[
    'https://images.unsplash.com/photo-1626668011687-a63fe9bc19a9',
    'https://images.unsplash.com/photo-1626668011673-f99c05a59eb0',
    'https://images.unsplash.com/photo-1626668011659-9e0c54c2e3d5'
  ],
  main_image_index = 0
